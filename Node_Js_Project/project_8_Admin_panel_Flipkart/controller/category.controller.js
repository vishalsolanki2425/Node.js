...
exports.deleteCategory = async (req, res) => {
    try {
        ...
        let s =  await subcategory.deleteMany({categoryname: category._id});
        let e =  await extracategory.deleteMany({categoryname: category._id});
        let p =  await Product.deleteMany({categoryname: category._id});
        console.log(s)
        console.log(e)
        console.log(p)
