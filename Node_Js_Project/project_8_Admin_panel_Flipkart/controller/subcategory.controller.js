...
exports.deleteSubCategory = async (req, res) => {
    try {
        ...
        let s = await extracategory.deleteMany({ subcategoryname: subcat._id });
        let p = await Product.deleteMany({subcategoryname: subcat._id});
        console.log(s)
        console.log(p)
...
exports.getAllSubCategories = async (req, res) => {
    try {
        ...
        return res.json({ subcategories, message: "All SubCategory Fetched!!!" });
    } catch (error) {
        console.log(error);
        req.flash("error", "Server Error");
        return res.redirect("/");
